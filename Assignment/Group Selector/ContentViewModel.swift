...
class ContentViewModel: ObservableObject {
    ...
    var allClassmates = [ "Kayla", "Lauryn","Thomas", "Angel", "Dawit","Joshua", "Cam", "Javin", "Jaylyn"]
    @Published
    var groups: String = ""
    ...
    func createGroups() {
        ...
        var classmates = allClassmates
        // TODO: Create a mutable string named result that is equal to an empty string
        var result: String = ""
        // TODO: Create a mutable int named count that is equal to 1
        var count: Int = 1
        ...
        while !classmates.isEmpty {
            ...
            let studentsPickedString = studentsPicked.joined(separator: ", ")         //TODO: add studentsPickedString to result
            result = result + studentsPickedString
